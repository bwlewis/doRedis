---
title: "`doRedis` Linux Service"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{`doRedis` Linux Service}
...
Please note that the `bash` shell is required by the doRedis service.
...
```
sudo R --slave -e "install.packages(c('devtools', 'foreach'), repos='https://cran.r-project.org')"
